...
/nat/content-rules/search

Shadow 정책 검색

/nat/shadow-rules/search

적용 정책 검색

/nat/apply-rules/search

미참조 정책 검색

/nat/unuse-rules/search

미참조 객체 검색

/nat/unuse-objects/search/days/{day}
...
/command/nat-policies/apply

/command/nat-policies/cancel
...
nat_rule_id
nat_rule_id: required (integer - minimum: 0 - maximum: 99999999)
NAT 정책 ID(세션 삭제: 필수, 조건 삭제: 옵션)
ANY:	0	또는	null
...
sip_mask
sip_mask: required (integer - minimum: 0 - maximum: 32)
출발지 서브넷 마스크
ANY:	0	또는	null
...
dip_mask
dip_mask: required (integer - minimum: 0 - maximum: 32)
목적지 서브넷 마스크
ANY:	0	또는	null
