...
/auth-portal/6/policies

/auth-portal/6/policies/{pk}

IPv6 인증 포탈 정책 설정 적용/취소

/command/auth-portal-6-policies/apply

/command/auth-portal-6-policies/cancel
