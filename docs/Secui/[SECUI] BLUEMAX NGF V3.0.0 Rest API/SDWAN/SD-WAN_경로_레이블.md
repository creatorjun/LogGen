...
/sdwan/path/labels/{pk}

후보 경로 레이블(인터페이스 고급 설정)

/sdwan/ifc/candidate/path/labels

적용/취소

/command/sdwan-path-lables/apply

/command/sdwan-path-lables/cancel
...
result
result: required (array of 경로 레이블)
결과 데이터
...
타입
0:	DIA,	1:	Overlay,	2:	Transport	Overlay
...
result
result: required (array of GetCandidatePathLabel)
결과 데이터

Items: GetCandidatePathLabel
Items
