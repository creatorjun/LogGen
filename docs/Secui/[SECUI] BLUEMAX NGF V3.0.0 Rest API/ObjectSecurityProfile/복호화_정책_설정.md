...
[호스트 객체 목록]
GET	{{url}}/api/op/host/4/objects
GET	{{url}}/api/op/network/4/objects?q=zone%3D1
zone(내부망: 1, 외부망: 2, DMZ: 3)

[네트워크 객체 목록]
GET	{{url}}/api/op/network/4/objects
GET	{{url}}/api/op/network/4/objects?q=zone%3D2
zone(내부망: 1, 외부망: 2, DMZ: 3)
...
/command/ssl-4-policies/apply

/command/ssl-4-policies/cancel
