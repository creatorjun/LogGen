...
/as/block-mail/profiles

/as/block-mail/profiles/{pk}

차단 메일 주소

/as/block-mail/profiles/{ppk}/items

/as/block-mail/profiles/{ppk}/items/{pk}

/as/block-mail/profiles/{ppk}/items/save?columns=(사용,메일 주소 목록,표현식,송/수신자 방향)

/as/block-mail/profiles/{ppk}/items/batch

차단 메일 주소 프로파일 적용/취소

/command/as-block-mail-profiles/apply

/command/as-block-mail-profiles/cancel
...
block_mail_list_id
block_mail_list_id: required (integer)
차단 메일 주소 프로파일 ID
...

{
		...
		"result":	[{
				...
				"name":	"차단	메일	주소	프로파일	이름",
				"desc":	"차단	메일	주소	프로파일	설명"
		}]
}
...
{
		"name":	"New	차단	메일	주소	프로파일	이름",
		"desc":	"New	차단	메일	주소	프로파일	설명"
}
...
차단 메일 주소 프로파일 ID( block_mail_list_id )
...
block_mail_id
block_mail_id: required (integer)
차단 메일 주소 ID
...
{
		"items":	[
				{"block_mail_list_id":	1,	"block_mail_id":	1,	"use":	1},
				{"block_mail_list_id":	1,	"block_mail_id":	2,	"use":	1}
		]
}
...
{
		"items":	[
				{"block_mail_list_id":	1,	"block_mail_id":	1},
				{"block_mail_list_id":	1,	"block_mail_id":	2}
		]
}
