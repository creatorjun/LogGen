...
/apt/exceptions/{ppk}/items

/apt/exceptions/{ppk}/items/{pk}

APT 예외 목록 적용/취소

/command/apt-exceptions/apply

/command/apt-exceptions/cancel
...
result
result: required (array of GetExcptProfile)
결과 데이터

Items: GetExcptProfile
Items
...
{
		"use":	1,
		"name":	"New	APT	예외	프로파일	이름",
		"desc":	"New	APT	예외	프로파일	설명"
}
...
{
		"items":	[
				{"apt_excpt_list_id":	1,	"use":	0},
				{"apt_excpt_list_id":	2,	"use":	0}
		]
}
...
APT 예외 프로파일 ID( apt_excpt_list_id )
...
apt_data_obj_list
apt_data_obj_list: required (array of integer)
예외 객체 ID 목록
...
{
		"items":	[
				{"apt_data_obj_id":	1,	"use":	0,	"http_use":	1,	"smtp_use":	1,	"pop3_use":	1,	"ftp_use":	1,	"imap_use":	1	},
				{"apt_data_obj_id":	2,	"use":	0,	"http_use":	0,	"smtp_use":	0,	"pop3_use":	0,	"ftp_use":	0,	"imap_use":	0	}
		]
}
