...
(3.0)SECUI Portal 설정 REST API 문서
...
/secui/portal/config/config

SECUI Portal 설정 적용/취소

/command/secui-portal/apply

/command/secui-portal/cancel
...
addr
addr: required (string - minLength: 1 - maxLength: 255)
SECUI Portal Agent 주소(IP 또는 도메인)

portport: (integer)
SECUI Portal Agent 접속 포트
10100	포트로	고정
