...
/command/server-nac/apply

/command/server-nac/cancel
...
nac_server_ip
nac_server_ip: required (string)
NAC 정책 서버 IP

nac_agent_mac: (string)
nac_agent_mac
NAC 에이전트 MAC 주소
MLSoft 일 경우 null

SupportedVersion:	2.5.1
...

{
		...
		"result":	{
				...
				"mode":	1,
				"version":	"5.12.01",
				"nac_server_ip":	"1.1.1.1",
				"nac_agent_mac":	"AA:BB:CC:DD:EE:FF"
		}
}
