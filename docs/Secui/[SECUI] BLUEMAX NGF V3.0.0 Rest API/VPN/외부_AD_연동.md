...
외부 Active Director 연동

/sslvpn/ext-ads

/sslvpn/ext-ads/{pk}

/sslvpn/ext-ads/{pk}/test/user

/sslvpn/ext-ads/{pk}/test/server

외부 Active Director 연동 적용/취소

/command/sslvpn-ext-ads/apply

/command/sslvpn-ext-ads/cancel
...
result
result: required (array of ResSslvpnExtAd)
결과 데이터

Items: ResSslvpnExtAd
Items
...
ad_svr_list
ad_svr_list: required (array of items)
Items: items
Items

ad_svr_id: required (integer)
ad_svr_id
외부 AD 아이디
...
Properties
items
items: required (array of ReqSslvpnExtAdList)
수정 아이템 목록

Items: ReqSslvpnExtAdList
Items
