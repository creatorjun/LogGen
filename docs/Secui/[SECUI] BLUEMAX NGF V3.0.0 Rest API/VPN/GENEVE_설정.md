...
/command/tunnel-geneve/apply

/command/tunnel-geneve/cancel
...
vnivni: required (integer - minimum: 0 - maximum: 16777215)
GENEVE VNI
...
GENEVE 터널링 설정 ID ( gre_ipip_tnl_id )
