...
/ipsec/4/remote-users

/ipsec/4/remote-users/{pk}

원격 사용자 등록 적용/취소

/command/ipsec-ipv4-remote-users/apply

/command/ipsec-ipv4-remote-users/cancel
...
ip_ver
ip_ver: required (one of 1, 2 - default: 1)
유형
IPv4:	1,	IPv6:	2
