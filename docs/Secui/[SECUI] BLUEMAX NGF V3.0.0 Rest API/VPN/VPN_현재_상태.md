...
/ipsec/status/branch/{name}

/ipsec/status/remote-user

/ipsec/status/remote-user/{name}
...
IPSec VPN 원격 사용자 터널 전체을(를) 삭제한다.
