...
/ipsec/4/abnormal-tunnels

/ipsec/4/abnormal-tunnels/{pk}

비정상 터널 우회 목록 적용/취소

/command/ipsec-ipv4-abnormal-tunnels/apply

/command/ipsec-ipv4-abnormal-tunnels/cancel
