...
4.2.11  방화벽  Shadow  정책  검색 .......................................................... 78

4.2.12  방화벽  시간만료  정책  검색 ........................................................ 79

4.2.13  방화벽  미참조  정책  검색 ........................................................... 80

4.2.14  방화벽  미참조  객체  검색 ........................................................... 81

4.2.15  방화벽  적용  정책  검색 ............................................................... 83

4.2.16  방화벽  정책그룹  목록  조회 ........................................................ 84

4.2.17  방화벽  정책그룹  추가 ................................................................. 85

4.2.18  방화벽  정책그룹  삭제 ................................................................. 86

4.2.19  방화벽  정책  임시  저장  조회 ...................................................... 87

4.2.20  방화벽  정책  임시  저장 ............................................................... 87

4.2.21  방화벽  정책  임시  저장  파일  삭제 ............................................. 88

4.2.22  방화벽  정책  임시  저장  파일  적용 ............................................. 89
...
4.3.1 IPv6  방화벽  정책  목록  조회 ......................................................... 91

4.3.2 IPv6  방화벽  정책  조회 .................................................................. 92

4.3.3 IPv6  방화벽  정책  추가 .................................................................. 94

4.3.4 IPv6  방화벽  정책  수정 .................................................................. 96

4.3.5 IPv6  방화벽  정책  삭제 .................................................................. 97

4.3.6 IPv6  방화벽  정책  이동-최상위로 .................................................. 98

4.3.7 IPv6  방화벽  정책  이동-최하위로 .................................................. 99

4.3.8 IPv6  방화벽  정책  이동-위로 ......................................................... 99

4.3.9 IPv6  방화벽  정책  이동-아래로 .................................................... 100

4.3.10 IPv6  방화벽  정책  내용  검색 ..................................................... 101

4.3.11 IPv6  방화벽  Shadow  정책  검색 ................................................ 104

4.3.12 IPv6  방화벽  시간만료  정책  검색 .............................................. 105

4.3.13 IPv6  방화벽  미참조  정책  검색 ................................................. 106

4.3.14 IPv6  방화벽  미참조  객체  검색 ................................................. 107

4.3.15 IPv6  방화벽  적용  정책  검색 ..................................................... 109

4.3.16 IPv6  방화벽  정책그룹  목록  조회 .............................................. 110

4.3.17 IPv6  방화벽  정책그룹  추가 ........................................................ 111

4.3.18 IPv6  방화벽  정책그룹  삭제 ....................................................... 112

4.3.19 IPv6  방화벽  정책  적용 .............................................................. 113

4.3.20 IPv6  방화벽  정책  취소 .............................................................. 113

4.4 NAT 정책 설정 ...................................................................... 114

4.4.1 NAT  정책  목록  조회.................................................................... 115

4.4.2 NAT  정책  조회 ............................................................................ 117

4.4.3 NAT  정책  사용  조회.................................................................... 118

4.4.4 NAT  정책  사용  수정.................................................................... 119
...
4.4.8 NAT  정책그룹  목록  조회 ............................................................ 124

4.4.9 NAT  정책그룹  추가 ..................................................................... 125

4.4.10 NAT  정책그룹  삭제 ................................................................... 125

4.4.11 NAT  정책  적용 ........................................................................... 126

4.4.12 NAT  정책  취소 .......................................................................... 127

4.5 IPv4 블랙리스트 .................................................................... 127

4.5.1  블랙리스트  목록  조회 ................................................................. 128

4.5.2  블랙리스트  추가 .......................................................................... 130

4.5.3  블랙리스트  삭제 .......................................................................... 132

4.5.4  만료된  블랙리스트  삭제 ............................................................. 133
